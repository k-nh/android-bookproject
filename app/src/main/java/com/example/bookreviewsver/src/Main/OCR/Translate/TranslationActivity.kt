package com.example.bookreviewsver.src.Main.OCR.Translate
...
class TranslationActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar = findViewById(R.id.tb_translation)
        ...
        val sourceLan = listOf("한국어","영어","일본어","베트남어","중국어","인도네시아어","태국어","독일어","러시아어","스페인어","프랑스어")
        val targetLan = listOf("한국어","영어","일본어","베트남어","중국어","인도네시아어","태국어","독일어","러시아어","스페인어","프랑스어")
